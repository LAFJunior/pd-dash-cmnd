  ...
  return <div className="space-y-8">
      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 relative z-10">
          {etapas.map((etapa, index) => <div key={etapa.id} className="relative">
                ...
                <CardContent className="pt-0">
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1">
                      {etapa.processos.map((processo, idx) => <li key={idx} className="text-xs text-gray-600 bg-gray-50 px-2 py-1 rounded">
                          {processo}
                        </li>)}
                    </ul>
                  </div>
              ...
              {index < etapas.length - 1 && <div className="hidden lg:flex absolute top-1/2 -right-3 transform -translate-y-1/2 z-20">
              ...
              {index < etapas.length - 1 && <div className="flex lg:hidden justify-center py-4">
