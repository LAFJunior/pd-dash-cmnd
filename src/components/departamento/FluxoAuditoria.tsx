  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-2xl font-bold text-gray-800 mb-2">Fluxo do Departamento de Auditoria</h3>
        <p className="text-gray-600">Processo estruturado de controle e conformidade</p>
      </div>
