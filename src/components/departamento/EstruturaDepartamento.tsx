    ...
    return <div className="p-6">
        ...
        <div className="flex justify-center mb-6">
          <div className="bg-[#545454] text-white rounded-[25px] px-8 py-3 text-center shadow-lg min-w-[280px] max-w-[380px]">
            <h2 className="text-2xl font-bold mb-0.5 tracking-wide">Sérgio Nascimento</h2>
            <div className="text-lg font-normal mb-1.5 tracking-wide">Head | PMO</div>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <div className="bg-[#737373] text-white rounded-[25px] px-8 py-3 text-center shadow-lg min-w-[280px] max-w-[380px]">
            <h2 className="text-2xl font-bold mb-0.5 tracking-wide">Geraldo Netto</h2>
            <div className="text-lg font-normal mb-1.5 tracking-wide">Analista de Projetos</div>
          ...
          <div className="bg-[#737373] text-white rounded-[25px] px-8 py-3 text-center shadow-lg min-w-[280px] max-w-[380px]">
            <h2 className="text-2xl font-bold mb-0.5 tracking-wide">Luiz Junior</h2>
            <div className="text-lg font-normal mb-1.5 tracking-wide">Aux. Processos</div>
