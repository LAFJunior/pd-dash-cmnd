...
const EstruturaDepartamento: React.FC<EstruturaDepartamentoProps> = ({
  ...
  if (departamento.toLowerCase().includes('financeiro')) {
    return <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-lg">
        <h3 className="text-lg font-semibold mb-6 text-center">Esse é o time do Financeiro-Varejo</h3>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-600 text-center min-w-[200px]">
            ...
            <h4 className="text-gray-800 font-semibold">Márcio Sampaio</h4>
            <p className="text-sm text-gray-600">Diretor Financeiro</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-purple-600 text-center">
            ...
            <h4 className="font-semibold text-gray-800">Analista Financeiro</h4>
          ...
          <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-orange-600 text-center">
            ...
            <p className="text-sm text-gray-600">Jully Silva</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-teal-600 text-center">
            ...
            <p className="text-sm text-gray-600">Milena Oliveira</p>
          </div>
        </div>
  ...
  return <div className="bg-gray-50 p-6 rounded-lg text-center">
