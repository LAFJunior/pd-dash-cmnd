    ...
    <div className="w-full overflow-x-auto">
      <div className="min-w-[1200px]">
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr>
              <th className="bg-gray-100 border border-black p-3 text-center font-bold">Jully - Sabrina</th>
              <th className="bg-gray-100 border border-black p-3 text-center font-bold">Milena</th>
              <th className="bg-gray-100 border border-black p-3 text-center font-bold">Taina - Mateus</th>
              <th className="bg-gray-100 border border-black p-3 text-center font-bold">Milena</th>
              <th className="bg-gray-100 border border-black p-3 text-center font-bold">Taína - Mateus</th>
              <th className="bg-gray-100 border border-black p-3 text-center font-bold">Jully - Sabrina</th>
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-black p-3 text-center align-top">
                ...
                <span className="block font-bold mb-1">Jô Calçados Ltda</span>
              </td>
              <td className="border border-black p-3 text-center align-top">
              ...
              <td className="border border-black p-3 text-center align-top">
                <span className="block font-bold mb-1">O&A</span>
                <span className="block font-bold mb-1">ABYS</span>
                <div className="text-left text-sm text-gray-700 border-t border-gray-300 pt-2 mt-2">
                </div>
              </td>
              <td className="border border-black p-3 text-center align-top">
