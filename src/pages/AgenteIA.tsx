...
const AgenteIA = () => {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setMediaFile(file);
    toast.success('Imagem carregada', { description: 'Imagem pronta para ser enviada.' });
  };
  ...
  const handleAudioUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!file.type.startsWith('audio/')) {
      toast.error('Arquivo inválido', { description: 'Por favor, selecione um arquivo de áudio.' });
      return;
    }
    ...
    setMediaFile(file);
    toast.success('Áudio carregado', { description: 'Áudio pronto para ser enviado.' });
  };
